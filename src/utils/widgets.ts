...
// Widget registry is built lazily (on first use) rather than at module-evaluation
// time. Some widgets transitively import this module (e.g. via settings/config
// helpers), so eagerly instantiating every widget here would trip a circular-import
// TDZ error when this module happens to be reached while one of those widget
// modules is still mid-evaluation.
